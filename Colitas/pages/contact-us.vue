  ...
  <section class="breadcrumb-bg" style="background-image: url(/background/page-title-bg-img.jpg); ">
    <div class="container">
      <div class="breadcrumb-holder">
        <div>
          <h1 class="breadcrumb-title">Contacto</h1>
...
<section class="py-8 py-md-10">
  <div class="container">
        ...
        <div class="col-sm-4 col-xs-12">
          <div class="media flex-md-column flex-lg-row mb-4">
            ...
            <div class="media-body">
              ...
              <p class="text-muted font-weight-medium">9/4 C Block, garden Street, Shyamoli, Dhaka.</p>
            </div>
          </div>
        </div>
          ...
          <div class="media flex-md-column flex-lg-row mb-3 mb-md-0">
            ...
            <div class="media-body">
              ...
              <p class="font-weight-medium">
                <a class="text-muted" href="mailto:colitas.abandonadas@gmail.com">colitas.abandonadas@gmail.com</a>  Or
                <a class="text-muted" href="mailto:hello1@example.com">hello1@example.com</a>
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="" action="index.html" method="post">
      <form>
        <div class="row">
          ...
          <div class="col-sm-6 col-xs-12">
            <div class="form-group form-group-icon">
              ...
              <input type="text" class="form-control border-purple" placeholder="Phone" required="">
            </div>
          </div>
          ...
          <div class="col-sm-6 col-xs-12">
            <div class="form-group form-group-icon">
              ...
              <input type="text" class="form-control border-pink" placeholder="Subject" required="">
            </div>
          </div>
...
<script setup>
useHead({
  title: 'Contacto - Colitas Abandonadas - Colitas Abandonadas'
})
