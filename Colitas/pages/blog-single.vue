  ...
  <section class="breadcrumb-bg" style="background-image: url(/background/page-title-bg-img.jpg); ">
    <div class="container">
      <div class="breadcrumb-holder">
        <div>
          <h1 class="breadcrumb-title">Noticia</h1>
          <ul class="breadcrumb breadcrumb-transparent">
            <li class="breadcrumb-item">
              <NuxtLink class="text-white" to="/">Inicio</NuxtLink>
            </li>
            <li class="breadcrumb-item text-white active" aria-current="page">Noticia</li>
          </ul>
        </div>
      </div>
    </div>
	...
	<div class="container">
		<div class="card">
			<div class="position-relative">
				<img class="card-img-top" src="/blog/blog-single-blog.jpg" alt="Card image cap">
          ...
          <span class="badge badge-rounded badge-warning"> 10 <br> July</span>
			...
			<div class="card-body border-top-5 px-3 rounded-bottom border-warning">
				<h3 class="card-title text-warning mb-5">Praesent Quis Felis Non Diam Volutpat Sollicitudin.</h3>
				<ul class="list-unstyled d-flex mb-5">
					<li class="">
						<a class="text-muted d-inline-block mr-3 fa fa-user mr-2"  href="#user"><i class="fa fa-user mr-2" aria-hidden="true"></i>Jone Doe</a>
					</li>
					<li class="mr-3">
						<a class="text-muted d-inline-block fa fa-comments-o mr-2"  href="#comments"><i class="fa fa-comments-o mr-2" aria-hidden="true"></i>4 Comments</a>
					</li>
				</ul>

				<p class="card-text text-justify mb-6">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source.</p>
				...
				<p class="card-text text-justify mb-6">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
		...
		<div class="bg-light shadow-sm rounded px-3 pt-3 pb-6 mb-4">
			...
			<div class="media py-1">
				<div class="mr-4">
					<img class=" rounded-circle" src="/blog/blog-sm-img1.jpg" alt="User Image">
				</div>
				<div class="media-body">
					...
					<p class="font-size-13 line-hight-21">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for
			...
			<div class="media py-1">
				<div class="mr-4">
					<img class=" rounded-circle" src="/blog/blog-sm-img2.jpg" alt="User Image">
				</div>
				<div class="media-body">
					<span class="mb-3 font-weight-medium text-muted d-inline-block">Sarah Smith</span>
					<time class="d-block text-muted font-size-13 mb-3">July 7, 2018</time>
			...
			<div class="media py-1">
				<div class="mr-4">
					<img class="rounded-circle" src="/blog/blog-sm-img3.jpg" alt="User Image">
				</div>
				<div class="media-body">
					<span class="mb-3 font-weight-medium text-muted d-inline-block">Sarah Smith</span>
					<time class="d-block text-muted font-size-13 mb-3">July 7, 2018</time>
			...
			<div class="media py-1">
				<div class="mr-4">
					<img class=" rounded-circle" src="/blog/blog-sm-img4.jpg" alt="User Image">
				</div>
				<div class="media-body">
					<span class="mb-3 font-weight-medium text-muted d-inline-block">Sarah Smith</span>
					<time class="d-block text-muted font-size-13 mb-3">July 7, 2018</time>
...
<script setup>
useHead({
  title: 'Noticia - Colitas Abandonadas - Colitas Abandonadas'
})
